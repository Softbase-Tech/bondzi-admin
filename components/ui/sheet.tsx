...
const sheetVariants = cva(
  "fixed z-50 bg-white border-slate-200 shadow-xl outline-none overflow-y-auto",
  {
    variants: {
      side: {
...
export const SheetHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col gap-1 px-6 py-4 border-b border-slate-200", className)} {...props} />
);
...
export const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "flex items-center justify-end gap-2 border-t border-slate-200 px-6 py-3",
      className,
    )}
    {...props}
  />
